...
, CASE when cf5.loan_type = 'affirm_go_v3' then 'PI4' 
         when cf5.loan_type = 'classic' and cf.apr > 0 then 'IB'
         when cf5.loan_type = 'classic' and cf.apr = 0 then '0pct' end as loan_type_checkout, 
